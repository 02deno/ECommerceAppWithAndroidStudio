...
public class TinyDB {
    ...
    public ArrayList<ItemDomain> getListObject(String key){
    	...
    	ArrayList<ItemDomain> objects =  new ArrayList<ItemDomain>();

    	for(String jObjString : objStrings){
    		ItemDomain value  = gson.fromJson(jObjString, ItemDomain.class);
    		objects.add(value);
    	}
    	return objects;
   }
...
//    }
//    
    public void putListObject(String key, ArrayList<ItemDomain> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(ItemDomain obj : objArray){
